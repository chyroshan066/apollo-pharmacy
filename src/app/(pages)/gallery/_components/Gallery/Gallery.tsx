        ...
        <div className="custom-container">
          ...
          <div className="enhanced-gallery-grid">
            {visibleMediaItems.map((item, index) => (
              ...
              >
                <div
                  className={`gallery-card ${styles.galleryCard}`}
                  onClick={() => openLightbox(index)}
                >
                  <div
                    className={`img-holder ${styles.galleryImage}`}
                    style={{
                  ...
                  >
                    {item.type === 'video' ? (
                      ...
                      <Image
                        ...
                        alt={item.alt}
                        fill
                        className={`img-cover ${styles.galleryImg}`}
                    ...
                    <div className={styles.galleryOverlay}>
                      <div className={styles.galleryContent}>
                        ...
                        <div className="gallery-actions">
                          <div className={styles.galleryIconWrapper}>
