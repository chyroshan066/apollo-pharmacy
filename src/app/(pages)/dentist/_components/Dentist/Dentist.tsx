...
export const Dentist = memo(() => {
    return (
        <main>
            {/* Hero Section*/}
            <section style={{
                background: 'linear-gradient(135deg, var(--deep-moss) 0%, var(--forest-green) 100%)',
                paddingTop: '30px',
                paddingBottom: '45px',
                marginTop: '95px'
            }}>
                    ...
                    <div className={styles.dentistProfileGrid}>
                        ...
                        <div
                            ...
                            <div style={{
                                ...
                                width: '150px',
                                height: '150px',
                                background: 'linear-gradient(135deg, var(--forest-green), var(--vibrant-lime))',
                                borderRadius: '50%',
                                opacity: '0.1',
                                zIndex: '1'
                            }}></div>
                            ...
                            <div style={{
                                ...
                                <div
                                    ...
                                    style={{
                                        background: 'linear-gradient(135deg, var(--pale-sage), #e8f5f0)',
                                ...
                                <div
                                    ...
                                    style={{
                                        background: 'linear-gradient(135deg, var(--darkest-forest), var(--deep-moss))',
                                        borderRadius: '15px',
                                        padding: '25px',
            ...
            <section style={{
                background: 'linear-gradient(135deg, var(--rich-charcoal-green) 0%, var(--darkest-forest) 100%)',
                padding: '100px 0',
                position: 'relative',
                overflow: 'hidden'
            }}>
                    ...
                    <div style={{
                        ...
                        <div
                            ...
                            <div style={{
                                ...
                                right: '0',
                                height: '6px',
                                background: 'linear-gradient(90deg, var(--forest-green), var(--vibrant-lime))'
                            }} />
