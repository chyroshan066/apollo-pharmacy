...
const alertStyles = {
    success: {
        container: "bg-[var(--forest-green)]/30 border-l-4 border-[var(--forest-green)] backdrop-blur-sm",
        icon: "text-[var(--forest-green)]",
        title: "text-[var(--deep-moss)]",
        message: "text-[var(--darkest-forest)]",
        closeButton: "text-[var(--stone-gray)] hover:text-[var(--forest-green)] hover:bg-[var(--forest-green)]/10 rounded-full",
    ...
    error: {
        ...
        title: "text-[var(--deep-moss)]",
        message: "text-[var(--darkest-forest)]",
        closeButton: "text-[var(--stone-gray)] hover:text-red-500 hover:bg-red-50 rounded-full",
