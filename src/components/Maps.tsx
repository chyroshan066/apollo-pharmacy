...
const CLINIC_LOCATIONS: ClinicLocation[] = [
    {
        ...
        address: "Hospital Road, Surunga, Jhapa, Nepal",
        phone: "9848136691"
    },
    {
        lat: 26.66061, 
        lng: 87.69839, 
        name: "Ortho Care & Trauma Centre / Pranshi Pharmacy",
        address: "Jaycees Chowk, Damak, Jhapa, Nepal",
        phone: "023-570944"
    }
];
        ...
        <section className="section">
            <div className="custom-container">
                ...
                <div className="text-center" style={{ marginBottom: '50px' }}>
                    ...
                    <p className="section-text" style={{
                        ...
                        Visit either of our conveniently located branches in Surunga or Damak for comprehensive medical care.
                    </p>
                </div>
                        ...
                        <div style={{
                            ...
                            <div style={{ textAlign: 'center' }}>
                                <div style={{
                                    ...
                                    borderTop: '4px solid var(--forest-green)',
                                    borderRadius: '50%',
                        ...
                        <div key={index} style={{
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    width: '30px',
                                    height: '30px',
                                    background: index === 0 ? 'var(--forest-green)' : 'var(--vibrant-lime)',
                                    borderRadius: '50%',
                                    display: 'flex',
                                    alignItems: 'center',
                                    justifyContent: 'center',
            ...
            <style jsx>{`
                ...
                :global(.leaflet-control-zoom a) {
                    ...
                    color: var(--darkest-forest) !important;
                    border: none !important;
