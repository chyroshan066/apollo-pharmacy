        ...
        >
            ...
            >
                <button
                    ...
                    onMouseOver={(e) => {
                        e.currentTarget.style.backgroundColor = 'var(--stone-gray)';
                    }}
                    onMouseOut={(e) => {
                        e.currentTarget.style.backgroundColor = 'var(--light-cream)';
                    }}
                    aria-label="Close modal"
                >
                    <XIcon
                        size={20}
                        style={{ color: 'var(--warm-slate)' }}
                    />
                </button>
                    ...
                    <div className="flex flex-col md:flex-row md:items-start gap-6 md:gap-8">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div
                                ...
                                style={{ borderTop: '1px solid var(--light-cream)' }}
                            >
                                            ...
                                            <div className="flex justify-center lg:justify-start">
                                                {isTextTruncated[index] && (
                                                    <button
                                                        ...
                                                        onMouseOut={(e) => {
                                                            e.currentTarget.style.color = 'var(--vibrant-lime)';
                                                        }}
                                                    >
                                                        Read More
                                                    </button>
                        ...
                        {TESTIMONIALS.map((_, index: number) => (
                            <button
                                ...
                                style={{
                                    ...
                                    height: '12px',
                                    borderRadius: 'var(--radius-6)',
                                    backgroundColor: index === currentSlide ? 'var(--vibrant-lime)' : 'var(--light-cream)',
                                    transition: 'var(--transition)',
                                    border: 'none',
                                    cursor: 'pointer'
                                }}
